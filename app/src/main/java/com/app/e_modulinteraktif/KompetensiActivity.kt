...
class KompetensiActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val videoPath =
            "android.resource://${packageName}/${R.raw.contoh1}" // Change "your_video_file" to your actual video file name
                                ...
                                .addOnSuccessListener { taskSnapshot ->
                                    fileReference.downloadUrl.addOnSuccessListener { uri ->
                                        ...
                                        databaseReference.child("users").child(username)
                                            .child("komentarcontoh1").setValue(komen)
                                        databaseReference.child("users").child(username)
                                            .child("filecontoh1").setValue(downloadUrl)
                                        databaseReference.child("users").child("list_pengguna")
                                            .child(username).child("komentarcontoh1")
                                            .setValue(komen)
                                        databaseReference.child("users").child("list_pengguna")
                                            .child(username).child("filecontoh1")
    ...
    private fun showDialog() {
        ...
        lanjut.setOnClickListener {
            nextDialog.dismiss()
            this.finish()
            val intent = Intent(this, Contoh2Activity::class.java)
