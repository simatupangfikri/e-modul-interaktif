...
import com.app.e_modulinteraktif.adapter.KomentarAdapter
...
class DaftarKomentarActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView = findViewById(R.id.recyclerKomentar)
        layoutManager = LinearLayoutManager(this)
        recyclerView.layoutManager = layoutManager
        recyclerView.setHasFixedSize(true)
        adapter = KomentarAdapter(this, arrayList)
