...
class SegiEmpatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val videoPath = "android.resource://${packageName}/${R.raw.materi1}"
                                ...
                                .addOnSuccessListener { taskSnapshot ->
                                    fileReference.downloadUrl.addOnSuccessListener { uri ->
                                        ...
                                        databaseReference.child("users").child(username)
                                            .child("komentarmateri1").setValue(komen)
                                        databaseReference.child("users").child(username)
                                            .child("filemateri1").setValue(downloadUrl)
                                        databaseReference.child("users").child("list_pengguna")
                                            .child(username).child("komentarmateri1")
                                            .setValue(komen)
                                        databaseReference.child("users").child("list_pengguna")
                                            .child(username).child("filemateri1")
