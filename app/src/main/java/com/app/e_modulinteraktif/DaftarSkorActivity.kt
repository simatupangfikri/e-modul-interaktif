...
import com.app.e_modulinteraktif.adapter.SkorAdapter
...
class DaftarSkorActivity : AppCompatActivity() {
    ...
    lateinit var adapter: SkorAdapter
    lateinit var arrayList: ArrayList<Pengguna>

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_daftar_skor)
        ...
        recyclerView = findViewById(R.id.recyclerSkor)
        layoutManager = LinearLayoutManager(this)
        recyclerView.layoutManager = layoutManager
        recyclerView.setHasFixedSize(true)
        adapter = SkorAdapter(this, arrayList)
